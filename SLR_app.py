...
#load  the save model
model=pickle.load(open(r"C:\Users\Lenovo\Documents\VS CODE\Linear_regression\linear_regression_model.pkl",'rb'))
...
st.write("The model was trained using a dataset of salaries and years of experience.built model by vagdevi.")